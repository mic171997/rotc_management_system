...
<html lang="en">
    ...
    <head>
        ...
        <title>Consolidate Advance & Actual Count (APP)</title>
        <style>
            body {
    ...
    <body>
        ...
        <table class="head1">
            <thead id="">
                <tr>
                    <th style="background-color: white;border: 0px;text-align: center;font-size: 15px;" colspan="4">
                        Consolidate Advance & Actual Count (APP)
                    </th>
                </tr>
                ...
                <tr>
                    <th style="text-align: left; ">Advance Count Date: {{ $dateTo }}</th>
                </tr>

                <tr>
                    <th style="text-align: left; ">Actual Count Date: {{ $dateFrom }}</th>
                </tr>
            </thead>
        </table>
        {{-- {{dd(1)}} --}}
        <table class="body1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">{{ $items['barcode'] }}</td>
                    <td style="text-align: left;">{{ $items['description'] }}</td>
                    <td style="text-align: center;">{{ $items['uom'] }}</td>
