								...
								<tr v-for="(datas, index) in getdata.data" :key="index">
									...
									<td>
										...
										<button class="btn btn-danger btn-xs  icon-lg add-tooltip" data-container="body"
											...
											@click="editBtn(datas.id, buttonclick = 'delete')">
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Back-End Adjustment</h5>
...
export default {
	...
	methods: {
		...
		async searchresult(page = 1) {
			...
			await axios.get(
				`/reports/backendadjustment/getResults/?date=${btoa(this.date)}&type=${this.Type}&bu=${this.business_unit}&dept=${this.department
